...
/// :nodoc:
SWIFT_CLASS("_TtC11OPPWAMobile28OPPCardDetailsAddressBuilder")
@interface OPPCardDetailsAddressBuilder : NSObject
+ (NSString * _Nullable)addressWithCity:(NSString * _Nullable)city state:(NSString * _Nullable)state postCode:(NSString * _Nullable)postCode SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@protocol OPPCardScanningViewControllerDelegate;
